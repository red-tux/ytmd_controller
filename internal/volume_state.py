...
VolumeControl and DialControl each used to derive this independently from the raw state, which
is how they could disagree - e.g. VolumeControl showed a stale volume % after muting via DialControl,
